...
| W4 — `azvpn up` end-to-end | **debugging** | AAD device-code + token cache + RPC handoff all working. `openvpn.exe` spawns and dies silently — root cause hidden until W6.4 lands. internal-app smoke-test is the acceptance bar. |
