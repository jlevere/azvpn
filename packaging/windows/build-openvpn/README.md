...
```sh
scp -J lab-bastion packaging/windows/build-openvpn/out/openvpn.exe \
    localuser@<win-test-ip>:'C:/Program Files/azvpn/openvpn/openvpn.exe'
```
...
## Why not native MSVC on win-test-vm
